...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    /* Garrett's changes: Calculate newWidth in terms of percentage instead of pixels */
    switch(size) {
      case "1":
        newWidth = 25;
        break;
    ...
    /* Garrett's changes: Storing results of querySelectorAll in a variable for one time evaluation */
